...
BiocManager::install("RNAAgeCalc", version = "3.10")
```
...
The main function to calculate RNASeq age is `predict_age`. This section 
explains each argument in `predict_age` function. 
...
`exprtype = "count"`, the raw count will be converted to FPKM. If `genelength` 
